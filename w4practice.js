...
// // Return undefined if text is not alpha.  "colour blue"
// function textToMorse(text) {
//     let alphabet, morseList = '', words, morse;

//     function convertWordToMorse (word) {
//         for(let i = 0; i < word.length; i++){
//             alphabet = word.charAt(i);
//             morseList += alpha[alphabet] + ' ';
//         }
//         return morseList.trim();
//     }
...
//     let morseWords, letters, char, list, words;

//     function convertMorseToWord (morseWord){
//         morseWord = morseWord.split(' ');
//         letters = morseWord.map(function(morseLetter){
...
//     words = morseWords.map(function(morseWord){
